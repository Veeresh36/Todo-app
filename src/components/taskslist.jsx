                                ...
                                <React.Fragment key={task.taskid}>
                                    <div className={`card-body ${style.card}`} target={index}>
                                        ...
                                        <div className={style.actions}>
                                            ...
                                            <button className={`btn btn-danger ${style.deleteBtn}`} onClick={() => deleteHandler(task.taskid)}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
